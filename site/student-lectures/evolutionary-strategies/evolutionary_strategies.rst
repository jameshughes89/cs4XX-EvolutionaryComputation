...
* Selection is performed stochastically. Better performing individuals are more likely to be selected as parents for the next generation. Pseudo code for simple evolutionary algorithm: 
